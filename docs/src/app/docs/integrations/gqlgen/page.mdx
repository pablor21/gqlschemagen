...
export const metadata = {
  title: "Integration with GQLGen",
  description:
    "Learn how to integrate GQLSchemaGen with GQLGen, enabling smooth schema generation and Go resolver workflows.",
};
...
<CodeBlock language="yaml" filename="gqlgen.yml">
  {`schema:
...
<NextButton href="/docs/integrations/vscode">VSCode</NextButton>
