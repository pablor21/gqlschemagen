...
- Complete type definitions (not fields inside generated types)
...
<Alert
  title="Placement Limitation"
  description="Preserved blocks are placed at the start or end of the file based on configuration. You cannot insert preserved content inside generated types."
  color="warning"
/>
